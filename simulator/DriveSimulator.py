...
class DriveSimulator:
    ...
    def __init__(self, monitor_, track_type_, trust_controller_on_):
        ...
        if self.track_type == "regular":
            self.pf.input_path_csv("./paths/full_path.csv")
        elif self.track_type == "reverse":
            self.pf.input_path_csv("./paths/reverse_path.csv")
        self.wp_idx = 0
    ...
    def init_obs(self):
        ...
        obs_file = ""
        if self.track_type == "regular":
            obs_file = "./paths/obstacles.csv"
        elif self.track_type == "reverse":
            obs_file = "./paths/reverse_path_obs.csv"
    ...
    def create_straight_path(self):
        with open("./paths/path.csv", "w") as csvfile:
